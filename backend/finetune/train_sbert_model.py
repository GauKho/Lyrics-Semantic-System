from data_loader import load_and_prepare_data, create_training_pairs_augmented, save_examples
...
def update_and_train_if_changed(data_folder, hash_path="data_hashes.json"):
    ...
    if current_hashes != old_hashes:
        ...
        train_examples = create_training_pairs_augmented(train_df, negative_ratio=2)
